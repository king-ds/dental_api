    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brush', models.IntegerField()),
                ('floss', models.IntegerField()),
                ('rinse', models.IntegerField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('normal_abnormal', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='track_record.NormalAbnormal')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('teeth_number', models.CharField(max_length=100)),
                ('teeth_status', models.CharField(max_length=100)),
                ('for_restoration', models.NullBooleanField()),
                ('is_approved', models.BooleanField(default=False)),
