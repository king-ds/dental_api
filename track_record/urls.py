...
urlpatterns = [
    ...
    path('track-record/diagnosis', views.CreateDiagnosis.as_view()),
    path('track-record/treatment-plan', views.CreateTreatmentPlan.as_view()),
    ...
    path('track-record/diagnosis/<int:track_record>', views.DiagnosisFeed.as_view()),
    path('track-record/treatment-plan/<int:track_record>', views.TreatmentPlanFeed.as_view()),
    ...
    path('track-record/diagnosis-detail/<int:id>', views.DiagnosisDetailView.as_view()),
    path('track-record/treatment-plan-detail/<int:id>', views.TreatmentPlanDetailView.as_view()),
